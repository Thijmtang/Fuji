...
for ($page = 1; $page <= $number_of_pages; $page++) {
    ...
    if ($page == $_GET['page']) {
        echo '<a href="Music.php?page=' . $page . '" style=" border-radius: 16%;color:White; padding:1%;background-color:#bed8bf; text-decoration: underline;margin-right:1%!important"> ' . $page . ' </a>';
    } else {
        echo '<a href="Music.php?page=' . $page . '" style=" border-radius: 16%;color:#bed8bf;padding:1%;background-color:#f3f3f4;margin-right:1%!important"> ' . $page . ' </a>';
    }
}
echo '</div>';
?>
